...
mod tests {
    ...
    #[test]
    #[ignore]
    fn test_java_lang_runtime_exception_2() -> io::Result<()> {
        init();
        ...
        let ex = RuntimeException::<()>::builder()
            .detail_message("fake")
            .stack_trace(stacker(11))
            .build_with_cause(&root);

        let raw = ex.to_bytes()?;

        assert_eq!(
            "",
            hex::encode(&raw)
        );
